...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-06 08:26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/edeed545-0f19-4ff7-965f-f475c9e36186.git
$ cd edeed545-0f19-4ff7-965f-f475c9e36186
```
